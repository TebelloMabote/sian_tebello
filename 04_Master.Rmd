...
>*Answer 1:* One would expect that there is a maximum amount of pigmentation due to chlorophyll in a Fynbos biome, or in any biome for that matter. After a fire, it is expected that new plants will grow, increasing the NDVI over time. Once the maximum is reached however, the NDVI levels out.
...
>*Answer 2:* They are relatively similar, all falling within 0.05 units of one another. Lambda has a much smaller p-value for the full model than for the simpler model. 
...
>*Answer 3:* Model 2 (RSS = 0.4528 compared to RSS of Model 1 = 0.7198)

Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?

>*Answer 4:* Two. They are the two additional parameters estimated in the full model: A and phi. 
...
>*Answer 5:* Yes, the full model has a much lower AIC value and so is preferred. 
...
>*Answer 6:* Models not fitted with Maximum Likelihood (such as the NLS models) should not have their AIC values calculated as they have not had their log-likelihood maximised. For this reason, the AIC values of the NLS models should not be compared to those of the MLE models.
